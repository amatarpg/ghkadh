...
import {
  ...
  validate,
  validate2
} from "./chunk-YMQ4Z3LR.js";
import {
  UserRejectedRequestError,
  isAddress
} from "./chunk-H3XQF4IM.js";
import {
  formatAbi,
  formatAbiItem,
  parseAbi
...
var InvalidVersionedHashVersionError = class extends BaseError {
  constructor({ hash: hash8, version }) {
...
function assert6(envelope) {
  ...
  if (blobVersionedHashes) {
    ...
    for (const hash8 of blobVersionedHashes) {
      ...
      const version = toNumber(slice2(hash8, 0, 1));
      if (size4 !== 32)
